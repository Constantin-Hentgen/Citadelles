...
// 				"rècupèration du personnage du condottiere");
...
// 		// crèation de quatre personnages
// 		Roi roi = new Roi();
...
// 		q = new Quartier("èchoppe",Quartier.TYPE_QUARTIERS[3],2); pioche.ajouter(q);
// 		q = new Quartier("basilique",Quartier.TYPE_QUARTIERS[4],4,"A la fin de la partie, ..."); 
// 		pioche.ajouter(q);
// 		q = new Quartier("cathèdrale",Quartier.TYPE_QUARTIERS[0],5); pioche.ajouter(q);
...
// 		q = new Quartier("hètel de ville",Quartier.TYPE_QUARTIERS[3],5); pioche.ajouter(q);
...
// 		// on rèaffiche la main de chaque joueur:
// 		System.out.print("Main du Roi (" + roi.getJoueur().getNom() + "): ");
// 		for(int i = 0; i< roi.getJoueur().nbQuartiersDansCite(); i++)
// 			System.out.print(mainRoi[i].getNom() + ", ");
// 		System.out.println("");
