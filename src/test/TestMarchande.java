...
public class TestMarchande {
	...
	public void test2(){
		...
		Test.test(marchande.getJoueur().nbPieces() == 4,
			"test du nombre de pieces d'or apres perception de ressources specifiques avec 2 quartiers commereants");
		marchande.utiliserPouvoir();
		Test.test(marchande.getJoueur().nbPieces() == 5,
				"test du nombre de pieces d'or apres utilisation du pouvoir");
